                ...
                <div class="bg-white p-3 border-t-4 border-green-400">
                    ...
                    <ul
                        ...
                        <div v-if="currentPerson">
                            ...
                            <li class="flex items-center py-3">
                                <span>Vous êtes</span>
                                <span v-if="currentPerson.cars && currentPerson.cars.length"  class="ml-auto">Conducteur !</span>
                        ...
                        <div class="text-gray-700">
                            <div v-if="currentPerson" class="grid md:grid-cols-2 text-sm">
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div v-if="currentPerson.tel === null" class="px-4 py-2 italic text-gray-500 hover:text-gray-600">Pas renseigné...</div>
                                    <div v-else class="px-4 py-2">{{ currentPerson.tel }}</div>
                                </div>
                                <div class="grid grid-cols-2">
                                    <div class="px-4 py-2 font-semibold">Email</div>
                                    <div class="px-4 py-2">
                                        <a class="text-blue-800" href="mailto:{{ currentPerson.email }}">{{ currentPerson.email }}</a>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="grid grid-cols-1">
                            <div>
                                ...
                                <ul  v-else class="list-inside space-y-2">
                                         <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">Rien à afficher ici pour l'instant ... </p>
                                </ul>
                            </div>
                        </div>
